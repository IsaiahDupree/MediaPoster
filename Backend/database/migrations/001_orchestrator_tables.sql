...
CREATE TRIGGER update_offer_traffic_tracking_updated_at
    BEFORE UPDATE ON offer_traffic_tracking
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

CREATE TRIGGER update_analytics_feedback_updated_at
    BEFORE UPDATE ON analytics_feedback
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
