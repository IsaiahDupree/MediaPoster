...
Uses FastAPI TestClient instead of requests to avoid requiring a running server.
"""
...
API_URL = "/api/comment-automation"
...
class TestConfiguration:
    ...
    def test_001_get_config_returns_200(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/config")
    ...
    def test_005_config_has_interval_settings(self):
        ...
        skip_if_no_client()
        data = client.get(f"{API_URL}/config").json()
    ...
    def test_008_update_config(self):
        """Can update config"""
        skip_if_no_client()
        response = client.put(f"{API_URL}/config", json={
            "daily_limit": 100,
            "per_niche_limit": 20,
    ...
    def test_009_get_niche_configs(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/config/niches")
        assert response.status_code == 200
    ...
    def test_011_get_specific_niche(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/config/niche/fitness")
        assert response.status_code in [200, 404]

    def test_012_update_niche_config(self):
        """Update niche config"""
        skip_if_no_client()
        response = client.put(f"{API_URL}/config/niche/gaming", json={
            "niche": "gaming",
            "daily_limit": 15,
            "priority": "high",
            "tone": "casual gamer",
    ...
    def test_013_delete_niche_config(self):
        ...
        skip_if_no_client()
        # Create first
        client.put(f"{API_URL}/config/niche/test_delete", json={
            "niche": "test_delete",
            "daily_limit": 5,
            "priority": "low",
            "tone": "test"
        })
        response = client.delete(f"{API_URL}/config/niche/test_delete")
        assert response.status_code == 200
    ...
    def test_014_get_platform_configs(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/config/platforms")
        assert response.status_code == 200
        assert isinstance(response.json(), list)
    ...
    def test_016_update_platform_config(self):
        ...
        skip_if_no_client()
        response = client.put(f"{API_URL}/config/platform/tiktok", json={
            "platform": "tiktok",
            "enabled": True,
            "daily_limit": 30,
    ...
    def test_022_niche_keywords_saved(self):
        ...
        skip_if_no_client()
        client.put(f"{API_URL}/config/niche/tech", json={
            "niche": "tech",
            "daily_limit": 10,
            "keywords": ["AI", "coding", "software"],
        })
        response = client.get(f"{API_URL}/config/niche/tech")
    ...
    def test_023_niche_exclude_keywords(self):
        ...
        skip_if_no_client()
        client.put(f"{API_URL}/config/niche/finance", json={
            "niche": "finance",
            "daily_limit": 10,
            "exclude_keywords": ["scam", "getrichquick"],
        })
        response = client.get(f"{API_URL}/config/niche/finance")
        if response.status_code == 200:
    ...
    def test_024_platform_target_accounts(self):
        ...
        skip_if_no_client()
        client.put(f"{API_URL}/config/platform/youtube", json={
            "platform": "youtube",
            "enabled": True,
    ...
    def test_025_platform_playlists_youtube(self):
        ...
        skip_if_no_client()
        response = client.put(f"{API_URL}/config/platform/youtube", json={
            "platform": "youtube",
            "enabled": True,
...
class TestContentDiscovery:
    ...
    def test_030_discover_endpoint_exists(self):
        """Discover endpoint exists (returns 501 - not yet implemented)"""
        skip_if_no_client()
        response = client.post(f"{API_URL}/discover", params={
            "platform": "tiktok",
            "niche": "fitness"
        })
        # Discovery requires platform API integration; 501 is correct
        assert response.status_code == 501

    def test_031_discover_returns_not_implemented(self):
        """Discover returns 501 with descriptive error"""
        skip_if_no_client()
        response = client.post(f"{API_URL}/discover", params={
            "platform": "tiktok",
            "niche": "fitness",
    ...
    def test_032_discover_tiktok(self):
        """Discover TikTok content returns 501"""
        skip_if_no_client()
        response = client.post(f"{API_URL}/discover", params={
            "platform": "tiktok",
            "niche": "comedy"
    ...
    def test_033_discover_youtube(self):
        """Discover YouTube content returns 501"""
        skip_if_no_client()
        response = client.post(f"{API_URL}/discover", params={
            "platform": "youtube",
            "niche": "tech"
    ...
    def test_034_discover_instagram(self):
        """Discover Instagram content returns 501"""
        skip_if_no_client()
        response = client.post(f"{API_URL}/discover", params={
            "platform": "instagram",
            "niche": "lifestyle"
    ...
    def test_036_targets_filter_by_platform(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/targets", params={
            "platform": "tiktok"
        })
        assert response.status_code == 200
    ...
    def test_042_get_top_comments(self):
        ...
        skip_if_no_client()
        targets = client.get(f"{API_URL}/targets").json()
        if targets["items"]:
            content_id = targets["items"][0]["id"]
            response = client.get(f"{API_URL}/targets/{content_id}/top-comments")
            assert response.status_code == 200
    ...
    def test_044_discover_limit_parameter_accepted(self):
        """Discover accepts limit parameter (returns 501 - not yet implemented)"""
        skip_if_no_client()
        response = client.post(f"{API_URL}/discover", params={
            "platform": "tiktok",
            "niche": "fitness",
...
class TestCommentGeneration:
    ...
    def test_050_generate_endpoint_exists(self):
        ...
        targets = client.get(f"{API_URL}/targets").json()
        if targets["items"]:
            response = client.post(f"{API_URL}/generate", json={
    ...
    def test_054_generate_batch(self):
        ...
        skip_if_no_client()
        response = client.post(f"{API_URL}/generate-batch", params={
            "count": 5
        })
        assert response.status_code == 200
    ...
    def test_061_comment_has_priority(self):
        ...
        skip_if_no_client()
        queue = client.get(f"{API_URL}/queue").json()
        if queue["items"]:
    ...
    def test_062_generate_multiple_targets(self):
        ...
        skip_if_no_client()
        targets = client.get(f"{API_URL}/targets", params={"limit": 3}).json()
...
class TestApprovalQueue:
    ...
    def test_070_get_queue(self):
        """Get approval queue"""
        skip_if_no_client()
        response = client.get(f"{API_URL}/queue")
        assert response.status_code == 200
    ...
    def test_073_queue_filter_by_status(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/queue", params={
    ...
    def test_076_approve_comment(self):
        ...
        if queue["items"]:
            ...
            response = client.post(f"{API_URL}/approve/{comment_id}")
            assert response.status_code == 200
    ...
    def test_077_approve_with_edit(self):
        ...
        if queue["items"]:
            comment_id = queue["items"][0]["id"]
            response = client.post(f"{API_URL}/approve/{comment_id}", params={
    ...
    def test_079_bulk_approve(self):
        ...
        if len(queue["items"]) >= 2:
            ...
            response = client.post(f"{API_URL}/approve-bulk", json={
                "comment_ids": ids
            })
            assert response.status_code == 200
    ...
    def test_080_reject_comment(self):
        ...
        if queue["items"]:
            comment_id = queue["items"][0]["id"]
            response = client.post(f"{API_URL}/reject/{comment_id}")
            assert response.status_code == 200
    ...
    def test_081_reject_with_reason(self):
        ...
        if queue["items"]:
            comment_id = queue["items"][0]["id"]
            response = client.post(f"{API_URL}/reject/{comment_id}", params={
                "reason": "Too generic"
            })
            assert response.status_code == 200
    ...
    def test_082_edit_comment(self):
        ...
        if queue["items"]:
            comment_id = queue["items"][0]["id"]
            response = client.post(f"{API_URL}/edit/{comment_id}", params={
    ...
    def test_084_approve_nonexistent_404(self):
        ...
        skip_if_no_client()
        response = client.post(f"{API_URL}/approve/nonexistent-id-12345")
        assert response.status_code == 404

    def test_085_reject_nonexistent_404(self):
        """Reject nonexistent returns 404"""
        skip_if_no_client()
        response = client.post(f"{API_URL}/reject/nonexistent-id-12345")
        assert response.status_code == 404

    def test_086_edit_nonexistent_404(self):
        """Edit nonexistent returns 404"""
        skip_if_no_client()
        response = client.post(f"{API_URL}/edit/nonexistent-id-12345", params={
            "new_text": "test"
        })
        assert response.status_code == 404
    ...
    def test_087_queue_stats_counts(self):
        ...
        skip_if_no_client()
        stats = client.get(f"{API_URL}/queue").json()["stats"]
...
class TestScheduling:
    ...
    def test_090_schedule_comment(self):
        ...
        if queue["items"]:
            comment_id = queue["items"][0]["id"]
            client.post(f"{API_URL}/approve/{comment_id}")
            response = client.post(f"{API_URL}/schedule/{comment_id}", params={
    ...
    def test_091_auto_schedule(self):
        ...
        skip_if_no_client()
        response = client.post(f"{API_URL}/auto-schedule", params={
            "hours_ahead": 24
        })
        assert response.status_code == 200
    ...
    def test_093_get_schedule(self):
        """Get schedule"""
        skip_if_no_client()
        response = client.get(f"{API_URL}/schedule")
        assert response.status_code == 200
    ...
    def test_095_schedule_filter_by_platform(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/schedule", params={
            "platform": "tiktok"
        })
        assert response.status_code == 200
    ...
    def test_098_post_comment(self):
        ...
        if queue["items"]:
            comment_id = queue["items"][0]["id"]
            client.post(f"{API_URL}/approve/{comment_id}")
            response = client.post(f"{API_URL}/post/{comment_id}")
            assert response.status_code == 200
...
class TestTracking:
    ...
    def test_110_get_tracking(self):
        """Get tracking data"""
        skip_if_no_client()
        response = client.get(f"{API_URL}/tracking")
        assert response.status_code == 200
    ...
    def test_112_tracking_filter_platform(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/tracking", params={
            "platform": "tiktok"
        })
        assert response.status_code == 200
    ...
    def test_113_update_engagement(self):
        ...
        if queue["items"]:
            comment_id = queue["items"][0]["id"]
            client.post(f"{API_URL}/approve/{comment_id}")
            client.post(f"{API_URL}/post/{comment_id}")
            response = client.post(f"{API_URL}/tracking/{comment_id}/update", params={
                "likes": 10,
                "replies": 2
            })
            assert response.status_code == 200
...
class TestImpactAnalysis:
    ...
    def test_120_get_impact(self):
        """Get impact analysis"""
        skip_if_no_client()
        response = client.get(f"{API_URL}/impact")
        assert response.status_code == 200
    ...
    def test_132_impact_period_daily(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/impact", params={
            "period": "daily"
        })
    ...
    def test_136_get_impact_breakdown(self):
        ...
        skip_if_no_client()
        response = client.get(f"{API_URL}/impact/breakdown")
        assert response.status_code == 200
...
class TestStatsMonitoring:
    ...
    def test_147_reset_automation(self):
        ...
        skip_if_no_client()
        response = client.post(f"{API_URL}/reset")
        assert response.status_code == 200
