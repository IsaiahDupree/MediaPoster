...
class TestAIClient:
    ...
    def test_init_unknown_provider(self, monkeypatch):
        ...
        # Should raise during validation in ModelConfig
        # But if it gets through, should raise in _init_client
    ...
    def test_chat_completion_openai(self, monkeypatch):
        ...
        with patch('services.ai_client.OpenAI', return_value=mock_client):
            client = AIClient(config)
    ...
    def test_chat_completion_groq(self, monkeypatch):
        ...
        with patch('services.ai_client.Groq', return_value=mock_client):
            client = AIClient(config)
    ...
    def test_transcribe_unsupported_provider(self, monkeypatch):
        ...
        with patch('services.ai_client.Anthropic'):
            client = AIClient(config)
    ...
    def test_embeddings_unsupported_provider(self, monkeypatch):
        ...
        with patch('services.ai_client.Groq'):
            client = AIClient(config)
